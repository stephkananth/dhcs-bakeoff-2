...
void scaffoldControlLogic()
{
  ...
  if (mousePressed && mouseDragged) {
    //text("mouseX", width-inchToPix(.8f), height-inchToPix(.4f));
    //text(mouseX - width/2, width-inchToPix(.8f), height-inchToPix(.4f) + 20);
    //text("pmouseX", width-inchToPix(.8f), height-inchToPix(.4f) - 60);
    //text(pmouseX - width/2, width-inchToPix(.8f), height-inchToPix(.4f) - 40);
    ...
    //// right side of screen dragging inwards, dec size
    //if (mouseX < pmouseX && mouseX - width/2 > screenTransX) {
    //  screenZ = constrain(screenZ-mouseSpeed, .01, inchToPix(4f)); //leave min and max alone!
    //}
    //// right side of screen dragging outwards, inc size
    //else if (mouseX > pmouseX && mouseX - width/2 > screenTransX) {
    //  screenZ = constrain(screenZ+mouseSpeed, .01, inchToPix(4f)); //leave min and max alone! 
    //}
    //// left side of screen dragging outwards, inc size
    //else if (mouseX < pmouseX && mouseX - width/2 < screenTransX) {
    //  screenZ = constrain(screenZ+mouseSpeed, .01, inchToPix(4f)); //leave min and max alone! 
    //}
    //// left side of screen dragging inwards, dec size
    //else if (mouseX > pmouseX && mouseX - width/2 < screenTransX) {
    //  screenZ = constrain(screenZ-mouseSpeed, .01, inchToPix(4f)); //leave min and max alone! 
    //}
    //// top side of screen dragging outwards, inc size
    //else if (mouseY > pmouseY && mouseY - height/2 > screenTransY) {
    //  screenZ = constrain(screenZ+mouseSpeed, .01, inchToPix(4f)); //leave min and max alone! 
    //}
    //// top side of screen dragging inwards, dec size
    //else if (mouseY < pmouseY && mouseY - height/2 > screenTransY) {
    //  screenZ = constrain(screenZ-mouseSpeed, .01, inchToPix(4f)); //leave min and max alone! 
    //}
    //// bottom side of screen dragging inwards, dec size
    //else if (mouseY > pmouseY && mouseY - height/2 < screenTransY) {
    //  screenZ = constrain(screenZ-mouseSpeed, .01, inchToPix(4f)); //leave min and max alone! 
    //}
    //// bottom side of screen dragging outwards, inc size
    //else if (mouseY < pmouseY && mouseY - height/2 < screenTransY) {
    //  screenZ = constrain(screenZ+mouseSpeed, .01, inchToPix(4f)); //leave min and max alone! 
    //}
