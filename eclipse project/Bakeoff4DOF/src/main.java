...
public class main extends PApplet
{
	...
	public void setup()
	{
		...
		rectMode(CENTER);
		textFont(createFont("Arial", inchToPix(.3f))); //sets the font to Arial that is .3" tall
		textAlign(CENTER);
	...
	public void draw()
	{
		background(40); // background is light grey
		fill(200);
		noStroke();
	...
	public void scaffoldControlLogic()
	{
		...
		if (mousePressed && dist(0, height, mouseX, mouseY)<inchToPix(.8f))
			screenZ = constrain(screenZ-inchToPix(.02f),.01f,inchToPix(4f)); //leave min and max alone!
